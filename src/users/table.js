    ...
    <div>
      ...
      <table className="table">
        <thead>
          ...
          <tr>
            <td>
              <input className = "form-control form-control-sm" value={user.password} onChange={(e) => setUser({ ...user, password: e.target.value })}/>
              <input className = "form-control form-control-sm" value={user.username} onChange={(e) => setUser({ ...user, username: e.target.value })}/>
            </td>
            <td>
            ...
            <td className="text-nowrap">
                ...
                <button className="btn text-primary fs-1 text me-0">
